...
('190000', '26917', "Мастер телепортации", "", 'Directions', '50000', 71, 71, 1.56, 1.56, 1.56, 35, 3, 1, 1.14286, 1.25, 1, 1, 1, 2, 7, 138936390, 3, 1, 2, 'SmartAI');
*/
...
(190000, 0, 0, 0, 0, 0, 26917, 0, 0, 0, 'Мастер телепортации', NULL, 'Directions', 50000, 71, 71, 0, 35, 3, 1, 1.14286, 1.25, 1, 1, 0, 0, 1, 1, 1, 2, 0, 0, 0, 7, 138936390, 0, 0, 0, 0, 0, 0, 0, 'SmartAI', 3, 1, 1.56, 1.56, 1.56, 1, 1, 0, 0, 1, 0, 0, 2, '', 0);
...
DELETE FROM gossip_menu WHERE MenuID>'50000'-1 AND TextID<'50000'+9;
...
DELETE FROM gossip_menu_option WHERE MenuID>'50000'-1 AND MenuID<'50000'+9;
...
ALTER TABLE creature AUTO_INCREMENT=701000;
...
delete from gameobject WHERE ID=@RUNE and guid>700999;
 
ALTER TABLE gameobject AUTO_INCREMENT=701000;
